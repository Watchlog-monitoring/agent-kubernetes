...
if [ -f "index.yaml" ]; then
    ...
    helm repo index . --url https://watchlog-monitoring.github.io/watchlog-helm-charts/
fi
...
echo "   helm repo add watchlog https://watchlog-monitoring.github.io/watchlog-helm-charts/"
